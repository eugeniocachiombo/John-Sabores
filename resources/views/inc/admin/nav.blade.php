<nav class="nav flex-column">
    ...
    <a href="{{ route('admin.recipe.category') }}" class="nav-link"><i class="fa fa-list me-2"></i> Categorias</a>
    <a href="{{ route('admin.recipes') }}" class="nav-link"><i class="fa fa-utensils me-2"></i> Receitas</a>
    <a href="{{ route('admin.users') }}" class="nav-link"><i class="fa fa-users me-2"></i> Usuários</a>
